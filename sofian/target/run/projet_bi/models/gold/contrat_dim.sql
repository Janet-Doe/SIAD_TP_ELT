  ...
  create  table "projet_siad_elt"."silver_gold"."contrat_dim__dbt_tmp"
...
WITH contrat_base AS (
    SELECT
        ...
        type_beneficiaire,
        code_profession
    FROM "projet_siad_elt"."silver"."silver_contrat"
),
...
classification AS (
    ...
    FROM "projet_siad_elt"."public"."bronze_classification"
)
