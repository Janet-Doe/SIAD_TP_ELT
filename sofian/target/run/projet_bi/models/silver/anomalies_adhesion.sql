  ...
  create  table "projet_siad_elt"."silver"."anomalies_adhesion__dbt_tmp"
...
WITH source AS (
    SELECT * FROM "projet_siad_elt"."public"."bronze_adhesion_detail"
),
...
beneficiaire AS (
    SELECT 
        ...
        TRIM(sexe) AS sexe
    FROM "projet_siad_elt"."public"."bronze_beneficiaire"
),
