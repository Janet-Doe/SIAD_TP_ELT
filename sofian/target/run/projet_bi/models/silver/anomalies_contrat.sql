  ...
  create  table "projet_siad_elt"."silver"."anomalies_contrat__dbt_tmp"
...
WITH adhesion AS (
    SELECT DISTINCT 
        ...
        code_profession 
    FROM "projet_siad_elt"."public"."bronze_adhesion_detail"
),

classification AS (
    SELECT code as code_prof FROM "projet_siad_elt"."public"."bronze_classification"
)
